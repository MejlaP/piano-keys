...
// functions that change the color of keys below
const keyPlay = event =>
...
let eventAllocation = note => {
    note.addEventListener('mousedown', keyPlay)
    note.addEventListener('mouseup', keyReturn)
}
// loop that runs the array of elements through the function
notes.forEach(eventAllocation)
